...
//-----------------------------------------------------------------------------------
//Create a Firebase Project and set Realtime database. Start it in test mode.
//Create a node GPS and its children named as f_latitude and f_longitude
#define FIREBASE_HOST "ENTER FIREBASE PROJECT ID"
#define FIREBASE_AUTH "ENTER FIREBASE AUTHENTICATION KEY"
